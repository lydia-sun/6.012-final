File {
Grid = "NEWFET_msh.tdr"
Current = "NEWFET_def.plt" 
Plot = "NEWFET_def.tdr" 
Output = "NEWFET_def.log"
}

Electrode {
{ Name="Drain_contact" Voltage=1.5 } * CHANGE THIS TO SET VDD
...
Goal{ Name="Gate_contact" Voltage=1.5 } *CHANGE THIS TO SET VDD
){ Coupled{ Poisson Electron Hole }}
}
