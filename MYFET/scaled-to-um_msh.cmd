...
Definitions {
	...
	Refinement "RefinementDefinition_1" {
		MaxElementSize = ( 0.001 0.0025 )
		MinElementSize = ( 0.0005 0.001 )
	}
	Multibox "MultiboxDefinition_1"
 {
		MaxElementSize = ( 0.025 0.015 )
		MinElementSize = ( 0.015 0.0001 )
		Ratio = ( 1 1.35 )
	}
}
...
Placements {
	...
	Refinement "RefinementPlacement_1" {
		...
		RefineWindow = Rectangle [(-0.035 0) (0.0525 -0.025)]
	}
	...
	Multibox "MultiboxPlacement_1" {
		...
		RefineWindow = Rectangle [(-0.035 0) (0.0525 0.3)]
	}
}
